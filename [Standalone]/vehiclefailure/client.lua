...
function CleanVehicle(vehicle)
	...
	QBCore.Functions.Progressbar("repair_vehicle", "Repairing...", math.random(10000, 20000), false, true, {
...
function RepairVehicleFull(vehicle)
	...
	QBCore.Functions.Progressbar("repair_vehicle", "Repairing Vehicle..", math.random(20000, 30000), false, true, {
		...
		QBCore.Functions.Notify("Vehicle Repaired, get to a mechanic to polish her up!")
		...
		TriggerServerEvent('cash-vehiclefailure:removeItem', "advancedrepairkit")
	end, function() -- Cancel
		StopAnimTask(GetPlayerPed(-1), "mini@repair", "fixing_a_player", 1.0)
...
function RepairVehicle(vehicle)
	...
	QBCore.Functions.Progressbar("repair_vehicle", "Repairing Vehicle..", math.random(10000, 20000), false, true, {
		...
		TriggerServerEvent('cash-vehiclefailure:removeItem', "repairkit")
	end, function() -- Cancel
		StopAnimTask(GetPlayerPed(-1), "mini@repair", "fixing_a_player", 1.0)
		QBCore.Functions.Notify("Mislukt!", "error")
		if (IsBackEngine(GetEntityModel(vehicle))) then
					...
					if cfg.sundayDriver and GetVehicleClass(vehicle) ~= 14 then -- Not for boats
						...
						if speed >= 1.0 then
							...
							if brake > 127 then
								...
								--exports['cash-vehicletuning']:SetVehicleStatus(GetVehicleNumberPlateText(vehicle), "brakes", exports['cash-vehicletuning']:GetVehicleStatus(GetVehicleNumberPlateText(vehicle), "brakes") - 0.01)
							end
...
function DamageRandomComponent()
	...
	--exports['cash-vehicletuning']:SetVehicleStatus(GetVehicleNumberPlateText(vehicle), randomComponent, exports['cash-vehicletuning']:GetVehicleStatus(GetVehicleNumberPlateText(vehicle), randomComponent) - randomDamage)
end
