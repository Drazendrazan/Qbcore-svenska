        ...
        if isLoggedIn then
            if PlayerJob.name == "police" then
                ...
                for k, v in pairs(Config.Locations["duty"]) do
                    if #(pos - vector3(v.x, v.y, v.z)) < 5 then
                        if #(pos - vector3(v.x, v.y, v.z)) < 1.5 then
                            if not onDuty then
                                DrawText3D(v.x, v.y, v.z, "~g~E~w~ - Gå i tjänst")
                            else
                                DrawText3D(v.x, v.y, v.z, "~r~E~w~ - Ta ledig/Gå hem")
                            end
                        ...
                        elseif #(pos - vector3(v.x, v.y, v.z)) < 2.5 then
                            DrawText3D(v.x, v.y, v.z, "På/Av Tjänst")
                        end
                    end
                end
                ...
                for k, v in pairs(Config.Locations["evidence"]) do
                    if #(pos - vector3(v.x, v.y, v.z)) < 2 then
                        if #(pos - vector3(v.x, v.y, v.z)) < 1.0 then
                            DrawText3D(v.x, v.y, v.z, "~g~E~w~ -    Bevisförråd")
                            if IsControlJustReleased(0, 38) then
                                TriggerServerEvent("inventory:server:OpenInventory", "Skåp", "policeevidence", {
                                    maxweight = 4000000,
                                    slots = 500,
                                })
                        ...
                        elseif #(pos - vector3(v.x, v.y, v.z)) < 1.5 then
                            DrawText3D(v.x, v.y, v.z, "Bevisförråd")
                        end
                    end
                end
                ...
                for k, v in pairs(Config.Locations["evidence2"]) do
                    if #(pos - vector3(v.x, v.y, v.z)) < 2 then
                        if #(pos - vector3(v.x, v.y, v.z)) < 1.0 then
                            DrawText3D(v.x, v.y, v.z, "~g~E~w~ - Bevisförråd")
                            if IsControlJustReleased(0, 38) then
                                TriggerServerEvent("inventory:server:OpenInventory", "Skåp", "policeevidence2", {
                                    maxweight = 4000000,
                                    slots = 500,
                                })
                ...
                for k, v in pairs(Config.Locations["evidence3"]) do
                    if #(pos - vector3(v.x, v.y, v.z)) < 2 then
                        if #(pos - vector3(v.x, v.y, v.z)) < 1.0 then
                            DrawText3D(v.x, v.y, v.z, "~g~E~w~ - Bevisförråd")
                            if IsControlJustReleased(0, 38) then
                                TriggerServerEvent("inventory:server:OpenInventory", "Skåp", "policeevidence3", {
                                    maxweight = 4000000,
                                    slots = 500,
                                })
                ...
                for k, v in pairs(Config.Locations["trash"]) do
                    if #(pos - vector3(v.x, v.y, v.z)) < 2 then
                        if #(pos - vector3(v.x, v.y, v.z)) < 1.0 then
                            DrawText3D(v.x, v.y, v.z, "~r~E~w~ - Soptunna")
                            if IsControlJustReleased(0, 38) then
                        ...
                        elseif #(pos - vector3(v.x, v.y, v.z)) < 1.5 then
                            DrawText3D(v.x, v.y, v.z, "Soptunna")
                        end
                    end
                end
                         ...
                         if onDuty then
                             ...
                             if #(pos - vector3(v.x, v.y, v.z)) < 1.5 then
                                 if IsPedInAnyVehicle(PlayerPedId(), false) then
                                     ...
                                     DrawText3D(v.x, v.y, v.z, "~g~E~w~ - Fordon")
                                 end
                                 if IsControlJustReleased(0, 38) then
                                     if IsPedInAnyVehicle(PlayerPedId(), false) then
                ...
                for k, v in pairs(Config.Locations["impound"]) do
                    if #(pos - vector3(v.x, v.y, v.z)) < 7.5 then
                        if onDuty then
                            ...
                            if #(pos - vector3(v.x, v.y, v.z)) < 1.5 then
                                if IsPedInAnyVehicle(PlayerPedId(), false) then
                                    DrawText3D(v.x, v.y, v.z, "~g~E~w~ - Beslagta fordon")
                                else
                                    DrawText3D(v.x, v.y, v.z, "~g~E~w~ - Polis beslag")
                                end
                                if IsControlJustReleased(0, 38) then
                                    if IsPedInAnyVehicle(PlayerPedId(), false) then
                                        QBCore.Functions.DeleteVehicle(GetVehiclePedIsIn(PlayerPedId()))
                ...
                for k, v in pairs(Config.Locations["helicopter"]) do
                    if #(pos - vector3(v.x, v.y, v.z)) < 7.5 then
                        if onDuty then
                            ...
                            if #(pos - vector3(v.x, v.y, v.z)) < 1.5 then
                                if IsPedInAnyVehicle(PlayerPedId(), false) then
                                    DrawText3D(v.x, v.y, v.z, "~g~E~w~ - Förvara helikopter")
                                else
                                    DrawText3D(v.x, v.y, v.z, "~g~E~w~ - Ta en helikopter")
                                end
                                if IsControlJustReleased(0, 38) then
                                    if IsPedInAnyVehicle(PlayerPedId(), false) then
                                        QBCore.Functions.DeleteVehicle(GetVehiclePedIsIn(PlayerPedId()))
                ...
                for k, v in pairs(Config.Locations["armory"]) do
                    if #(pos - vector3(v.x, v.y, v.z)) < 4.5 and IsArmoryWhitelist() then
                        if onDuty then
                            if #(pos - vector3(v.x, v.y, v.z)) < 1.5 then
                                DrawText3D(v.x, v.y, v.z, "~g~E~w~ - Vapenförråd")
                                if IsControlJustReleased(0, 38) then
                                    SetWeaponSeries()
                                    TriggerServerEvent("inventory:server:OpenInventory", "shop", "police", Config.Items)
                                end
                            elseif #(pos - vector3(v.x, v.y, v.z)) < 2.5 then
                                DrawText3D(v.x, v.y, v.z, "Vapenförråd")
                            end  
                        end
                    end
                end
...
function MenuImpound()
    ...
    MenuTitle = "Impounded"
    ClearMenu()
    Menu.addButton("Polis beslag", "ImpoundVehicleList", nil)
...
function removeOutfit(oData)
    ...
    QBCore.Functions.Notify(oData.outfitname.." är raderad", "success", 2500)
    closeMenuFull()
end
...
function MenuGarage()
    ...
    MenuTitle = "Garage"
    ClearMenu()
    Menu.addButton("Fordon", "VehicleList", nil)
    Menu.addButton("Stäng menyn", "closeMenuFull", nil) 
end
...
function VehicleList(isDown)
    ...
    Menu.addButton("Tillbaks", "MenuGarage",nil)
end
