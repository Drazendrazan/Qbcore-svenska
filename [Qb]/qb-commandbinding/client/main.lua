                ...
                if IsControlJustPressed(0, Keys[v]) or IsDisabledControlJustPressed(0, Keys[v]) then
                    ...
                    if next(keyMeta) ~= nil then
                        if keyMeta[v]["command"] ~= "" then
                            ...
                            QBCore.Functions.Notify('Det finns fortfarande ingenting ['..v..'] bunden, /binds att binda ett kommando', 'primary', 4000)
                        end
                    else
                        QBCore.Functions.Notify('Du har inte bundit några kommandon, /binds att binda ett kommando', 'primary', 4000)
                    end
                end
            end
...
RegisterNUICallback('save', function(data)
    ...
    QBCore.Functions.Notify('Kommandobindningar finns lagrade!', 'success')
