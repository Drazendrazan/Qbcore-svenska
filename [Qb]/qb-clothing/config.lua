...
Config.ClothingRooms = {
	...
	[2] = {requiredJob = "police", x = 462.83, y = -999.09, z = 30.69, cameraLocation = {x = 461.15, y = -999.04, z = 30.69, h = 269.44}},
	[3] = {requiredJob = "police", x = 460.45, y = -996.49, z = 30.69, cameraLocation = {x = 458.14, y = -996.41, z = 30.69, h = 268.7}},
	[4] = {requiredJob = "police", x = 462.63, y = -996.43, z = 30.69, cameraLocation = {x = 461.09, y = -996.44, z = 30.69, h = 278.59}},	
    [5] = {requiredJob = "doctor", x = 1462.64, y = 693.23, z = 33.51, cameraLocation = {x = 1462.76, y = 695.59, z = 33.51, h = 175.01}},
    [6] = {requiredJob = "ambulance", x = 311.05, y = -596.19, z = 43.28, cameraLocation = {x = 309.61, y = -595.57, z = 43.28, h = 248.12}},
    [7] = {requiredJob = "police", x = 314.76, y = 671.78, z = 14.73, cameraLocation = {x = 317.62, y = 671.86, z = 14.73, h = 91.53}},
    [8] = {requiredJob = "ambulance", x = 338.70, y = 659.61, z = 14.71, cameraLocation = {x = 339.27, y = 661.63, z = 14.71, h = 315.5}},    
    [9] = {requiredJob = "doctor", x = 338.70, y = 659.61, z = 14.71, cameraLocation = {x = 339.27, y = 661.63, z = 14.71, h = 315.5}}, 
	[10] = {requiredJob = "ambulance", x = -1098.45, y = 1751.71, z = 23.35, cameraLocation = {x = -1097.15, y = 1750.19, z = 23.35, h = 38.70}},    
    [11] = {requiredJob = "doctor", x = -1098.45, y = 1751.71, z = 23.35, cameraLocation = {x = -1097.15, y = 1750.19, z = 23.35, h = 38.70}},
	[12] = {requiredJob = "police", x = -77.59, y = -129.17, z = 5.03, cameraLocation = {x = -80.36, y = -130.76, z = 5.03, h = 300.44}},
}
...
Config.Outfits = {
    ["police"] = {
        ["male"] = {
            [1] = {
                outfitLabel = "Rikspolischef",
                outfitData = {
                    ["pants"]       = { item = 10, texture = 0},  -- PANTS
                    ["arms"]        = { item = 1, texture = 0},  -- ArmS
                    ["t-shirt"]     = { item = 96, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 0, texture = 0},  -- VEST
                    ["torso2"]      = { item = 289, texture = 0},  -- JACKET
            ...
            [3] = {
                outfitLabel = "Bomb Klader",
                outfitData = {
                    ["pants"]       = { item = 84, texture = 0},  -- Broek
                    ["arms"]        = { item = 31, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 97, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 0, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 186, texture = 1},  -- Jas / Vesten
                    ["shoes"]       = { item = 33, texture = 0},  -- Schoenen
                    -- ["decals"]      = { item = 7, texture = 0},  -- Decals
                    ["accessory"]   = { item = -1, texture = 0},  -- Nek / Das
                    ["bag"]         = { item = 0, texture = 0},  -- Tas
                    ["hat"]         = { item = 89, texture = 0},  -- Pet
                    ["glass"]       = { item = 0, texture = 0},  -- Bril
            --      ["ear"]         = { item = 0, texture = 0},  -- Oor accessoires
                    ["mask"]         = { item = 0, texture = 0},  -- Masker
                },
        ...
        ["female"] = {
            [1] = {
                outfitLabel = "Rikspolischef",
                outfitData = {
                    ["pants"]       = { item = 213, texture = 0},  -- Broek
                    ["arms"]        = { item = 0, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 213, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 0, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 213, texture = 1},  -- Jas / Vesten
                    ["shoes"]       = { item = 25, texture = 0},  -- Schoenen
        ...
        ["female"] = {
            [1] = {
                ...
                outfitData = {
                    ...
                    ["vest"]        = { item = 0, texture = 0},  -- VEST
                    ["torso2"]      = { item = 159, texture = 1},  -- JACKET
