...
function setupLocations(locations, myHouses) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Vart vill du börja?"><p><span id="null">Vart vill du börja?</span></p></div>')
    
    setTimeout(function(){
        $(parent).append('<div class="location" id="location" data-location="current" data-type="current" data-label="Senaste platsen"><p><span id="current-location">Senaste platsen</span></p></div>');
...
function setupApps(apps) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Välj lägenhet"><p><span id="null">Välj lägenhet</span></p></div>')
