    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            if (data.toggle) {
                ...
                var originalText = "Hämtar spelardata";
                ...
                var DotsInterval = setInterval(function() {
                    ...
                    if (loadingProgress == 3) {
                        originalText = "Validerar spelardata"
                        $("#loading-text").html(originalText);
                    }
                    if (loadingProgress == 4) {
                        originalText = "Hämtar karaktärer"
                        $("#loading-text").html(originalText);
                    }
                    if (loadingProgress == 6) {
                        originalText = "Validerar karaktärer"
                        $("#loading-text").html(originalText);
                    }
                    if(loadingDots == 4) {
                        $("#loading-text").html(originalText);
...
function setupCharInfo(cData) {
    if (cData == 'empty') {
        $('.character-info-valid').html('<span id="no-char">Den valda karaktärerplatsen används inte ännu.<br><br>Denna karaktär har ingen information än.</span>');
    } else {
        var gender = "Man"
        ...
        '<div class="character-info-box"><span id="info-label">Stad: </span><span class="char-info-js">'+cData.charinfo.nationality+'</span></div>' +
        ...
        '<div class="character-info-box"><span id="info-label">Mobil nummer: </span><span class="char-info-js">'+cData.charinfo.phone+'</span></div>' +
