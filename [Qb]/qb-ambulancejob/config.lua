...
Config.Locations = {
    ...
    ["vehicle"] = {
        [1] = {x = 319.72, y = -585.57, z = 28.38, h = 340.42},
        [2] = {x = 323.02, y = -587.11, z = 28.38, h = 342.27},
		[3] = {x = 326.09, y = -588.49, z = 28.39, h = 341.75},
		[4] = {x = 329.54, y = -589.45, z = 28.38, h = 342.02},
		[5] = {x = 332.59, y = -590.83, z = 28.39, h = 340.41},
		[6] = {x = 315.87, y = -577.96, z = 28.38, h = 249.12},
		[7] = {x = 317.49, y = -573.93, z = 28.39, h = 252.9},
		[8] = {x = 318.86, y = -569.6, z = 28.38, h = 250.08},
		[9] = {x = 321.04, y = -565.25, z = 28.38, h = 246.84},
    },
    ["helicopter"] = {
...
Config.Vehicles = {
    ["ambulance7"] = "XC70",
    ["ambulance1"] = "Volkswagen",
	["ambulance11"] = "Volkswagen Tiguan",
	["ambulance2"] = "Renault Master",
}
...
Config.BleedingStates = {
    [1] = {label = 'blöder lite..', damage = 10, chance = 50},
    [2] = {label = 'blödning..', damage = 15, chance = 65},
    [3] = {label = 'blöder mycket..', damage = 20, chance = 65},
    [4] = {label = 'blöder väldigt mycket..', damage = 25, chance = 75},
}
